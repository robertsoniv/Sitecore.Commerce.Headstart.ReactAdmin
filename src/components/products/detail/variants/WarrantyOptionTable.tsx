...
interface WarrantyOptionTableProps {
  control: Control<SpecFieldValues>
  validationSchema: any
  trigger: UseFormTrigger<any>
}
export function WarrantyOptionTable({control, validationSchema, trigger}: WarrantyOptionTableProps) {
  const {
    fields: options,
    append,
    remove
    ...
    <>
      <TableContainer width="full">
        <Table>
          <Thead>
            <Tr>
              <Th padding={tableCellPadding}>Warranty Option</Th>
